...
#ifdef BCM_HARDWARE
        // ICS seems to use the last attempted config, but KitKat doesn't.
        // This avoids surfaceflinger from choosing an invalid/undefined config,
        // but it's probably not right. Needs to be checked.
        *outConfig = configs[7];
        delete [] configs;
        return NO_ERROR;
#endif
